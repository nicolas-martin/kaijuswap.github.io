...
import CyberpunkCircuit from "./svgs/cyberpunkCircuit";
      ...
      <div className="flex flex-col md:flex-row">
        <div className="relative flex-1 flex items-center">
          ...
          <div className="h-full w-full flex items-center justify-center">
            <h3 className="text-center font-bold text-3xl flex flex-col items-center mb-8 md:mb-0 md:text-left tracking-wider leading-relaxed">
        ...
        >
          {faq.qa.map((qa, index) => (
            <motion.div
              ...
              className={clsx(
                "border-2 border-[#00E5FF]/30 my-2 collapse collapse-arrow cyberpunk-faq-item",
                {
